...
<template>
    <div class="overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-950">
        <component
            ...
            :href="selectionMode ? undefined : `/games/${game.id}`"
        ...
        >
            ...
            <div class="min-w-0 flex-1">
                ...
                <div
                    class="mt-2 flex flex-wrap items-center gap-3 text-sm text-zinc-400"
                >
            ...
            <div class="hidden text-right sm:block">
                <p
                    class="text-xs font-bold tracking-wide text-zinc-500 uppercase"
                >
                    Playtime
                </p>

                <p class="mt-1 text-sm font-bold text-white">
                    {{ Math.round(game.average_playtime_minutes / 60) }}h
                </p>
            </div>
        ...
        <div v-if="!games.length" class="p-8 text-center text-sm text-zinc-500">
            No games found.
        </div>
    </div>
</template>
