            ...
            <main class="flex-1 px-8 py-10">
                <div class="mx-auto max-w-7xl space-y-8">
                    ...
                    <div class="grid gap-4 md:grid-cols-3">
                        ...
                        >
                            <div
                                class="absolute right-5 top-3 text-7xl text-zinc-800"
                            >
                                ▦
                            </div>
                            ...
                            >
                                ...
                                <p
                                    class="pb-1 text-sm text-zinc-400"
                                >
                                    games
                                </p>
                            </div>
                        ...
                        >
                            <div
                                class="absolute right-5 top-2 text-7xl text-zinc-800"
                            >
                                ✓
                            </div>
                    ...
                    <div
                        class="grid gap-8 xl:grid-cols-[400px,1fr]"
                    >
                        <div
                            class="rounded-3xl border border-zinc-800 bg-zinc-900"
                        >
                            <button
                                type="button"
