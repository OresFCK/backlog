    ...
    <div class="flex min-h-screen bg-zinc-950 text-white">
        ...
        <div class="flex flex-1 flex-col">
            ...
            <main class="flex-1 space-y-8 p-8">
                ...
                >
                    <div>
                        <h1 class="text-3xl font-black">Custom Lists</h1>

                        <p class="mt-2 max-w-2xl text-zinc-400">
                            Create your own rankings, collections and favorite
                            game lists.
                        </p>
                    </div>
                </section>
                ...
                <section class="grid gap-6 xl:grid-cols-[380px_1fr]">
                    ...
                    >
                        <h2 class="text-xl font-bold">Create list</h2>
                    ...
                    >
                                ...
                                <template v-else>
                                    <Link :href="`/lists/${list.id}`">
                                        ...
                                        >
                                            ...
                                            <span
                                                class="rounded-full border border-zinc-700 px-3 py-1 text-xs text-zinc-400"
                                            >
                                                {{ list.visibility }}
                                            </span>
                                        </div>
                        ...
                        >
                            <p class="font-bold">No custom lists yet</p>
